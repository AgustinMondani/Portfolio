    ...
    <div className="fixed flex justify-center top-3 z-50 w-full h-15 bg-transparent bg-opacity-10">
      <div className="pt-1 backdrop-filter backdrop-blur-lg rounded-3xl border-2 border-gray-600">
        <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
          ...
          <a href='#perfil' className="inline-flex flex-col items-center justify-center px-5 group">
          ...
          <a href='#proyectos' className="inline-flex flex-col items-center justify-center px-5 group">
            ...
            <a href="#habilidades" className="inline-flex flex-col items-center justify-center px-5 group">
          ...
          <a href='#contacto' className="inline-flex flex-col items-center justify-center px-5 group">
